if(!jQuery.fn.lmCarousel){
    jQuery.fn.lmCarousel = function(obj){
        var defaults = {
            ...
            height : 450,
            idx : 0,
            type : "fade",//垂直vertical    水平：horizontal   淡入淡出 fade
            seamless : true //无缝滚动
        }
        ...
        var showPic = ()=>{
            ...
            $(".shushu").html(opt.idx);
            // $page.children(opt.idx).addClass("active").siblings().removeClass('active');
        }
        // var createPage = ()=>{
        //     $page  = $("<div/>"); 
        //     $page.addClass("page");
