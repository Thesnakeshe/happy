if(!jQuery.fn.mjCarousel2){
    jQuery.fn.mjCarousel2 = function(obj){
        var defaults = {
            imgs: [],
            bgColor: [],
            width: 1000,
        ...
        var init = ()=>{
            ...
            $(this).addClass("focus3").append($ul).css({width:opt.width,height:opt.height});
            ...
            if(opt.type=="fade"){
                ...
                if(opt.seamless==true){
                    ...
                    $ul.addClass('horizontal').width(opt.width*(opt.imgs.length)).height(opt.height);
                }
        ...
        var createPage = ()=>{
            ...
            for(let i=0;i<opt.imgs.length;i++){
                $("<span/>").appendTo($page).on("mouseover",function(){
                        opt.idx = i;
                        showpic();
                });
            }
